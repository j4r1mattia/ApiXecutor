 ...
 */
async function getCollections(dir) {
...
function isValidCollection(filePath) {
  ...
  try {
    /*
     * using `fs.readFileSync(filePath, 'utf8')` in Node 20, break the test due to mock-fs bug
     * [issue #377](https://github.com/tschaub/mock-fs/issues/377)
     *
     * TODO introduce 'utf8' when bug will solved
     */
...
export { ERROR_MESSAGES, getCollections };
